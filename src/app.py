...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and matches for students who enjoy soccer",
    ...
    "Music Ensemble": {
        "description": "Practice instruments and perform group music pieces",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore science projects",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["lucas@mergington.edu", "ella@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Team training and matches for basketball enthusiasts",
    ...
    "Tennis Club": {
        ...
        "max_participants": 16,
        "participants": ["logan@mergington.edu", "oliver@mergington.edu"]
    },
    "Photography Club": {
    ...
    "Drama Club": {
        "description": "Perform theater productions and develop acting skills",
        "schedule": "Mondays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["zoe@mergington.edu", "lily@mergington.edu"]
    },
    "Model United Nations": {
        "description": "Simulate international diplomacy and debate global issues",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["noah.s@mergington.edu", "lucas.p@mergington.edu"]
    },
    "Robotics Club": {
